...
- [Joystick Gremlin Ex - 13.40.14ex (m22)](#joystick-gremlin-ex---134014ex-m22)
  - [Contents](#contents)
- [Changelog](#changelog)
    - [6/6/24 - 13.40.13ex (h) **potentially breaking change**](#6624---134013ex-h-potentially-breaking-change)
...
- [Copy/Paste operations](#copypaste-operations-1)
- [VJoyRemap action](#vjoyremap-action-1)
...
- [Plugin Script enhancements](#plugin-script-enhancements)
    - [@gremlin.input\_devices.gremlin\_start](#gremlininput_devicesgremlin_start)
    - [@gremlin.input\_devices.gremlin\_stop](#gremlininput_devicesgremlin_stop)
    - [@gremlin.input\_devices.gremlin\_mode](#gremlininput_devicesgremlin_mode)
    - [@gremlin.input\_devices.gremlin\_state](#gremlininput_devicesgremlin_state)
- [Recipes](#recipes)
